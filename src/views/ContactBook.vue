...
<template>
    <div class="page row m-auto">
        ...
        <div class="mt-3 col-md-6">
            ...
            <ContactList v-if="fillteredContactsCount > 0" 
                :contacts="filteredContacts" v-model:activeIndex="activeIndex" 
            />
            <p v-else class="text-secondary">Không có liên hệ nào.</p>
